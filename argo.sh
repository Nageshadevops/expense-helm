...
#fi
  ...
  for app in backend frontend ; do
     argocd app create ${app}  --repo https://github.com/Nageshadevops/expense-helm --path chart --dest-namespace default --dest-server https://kubernetes.default.svc --grpc-web --values values/${app}.yaml
  done
